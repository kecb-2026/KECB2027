...
# HOME (ADMIN NUR)
    ...
    if kat3: updated_kats.append("3")
    if kat4: updated_kats.append("4")
...
# --- NEUER MENÜPUNKT: QR CODES ---
    ...
    base_url = "https://kecb2027.streamlit.app/"
    ...
    def generate_pdf_download(df):
        ...
        all_qr_items = []
        shows_config = [
            ("Richter Show 1", "SHOW A", "A", "Richter Show 1"),
            ("Richter Show 2", "SHOW B", "B", "Richter Show 2"),
            ("Richter Show 3", "SHOW C", "C", "Richter Show 3")
        ]
    ...
    render_web_show_tabs(tab_show_a, "SHOW A", "Richter Show 1", "A", "Richter Show 1")
    render_web_show_tabs(tab_show_b, "SHOW B", "Richter Show 2", "B", "Richter Show 2")
    render_web_show_tabs(tab_show_c, "SHOW C", "Richter Show 3", "C", "Richter Show 3")
